...
import donateImg from "@/assets/donate (2).png";
...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen font-sans bg-white">
      ...
      {/* Hero Section */}
      <section className="relative h-screen flex items-end md:items-center justify-start overflow-hidden pb-32 md:pb-0">
      ...
      <section id="join-us" className="py-24 bg-[#FAFAFA]">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            {/* Left side form */}
            <div className="bg-gradient-to-b from-[#85291A] via-[#45120A] to-[#85291A] p-10 rounded-[2.5rem] shadow-2xl min-h-[700px] order-2 md:order-1">
            ...
            <div className="space-y-12 order-1 md:order-2">
              <h2 className="text-5xl md:text-6xl font-odibee text-[#8B2D1B] text-center md:text-right">Join Hands, Be the Change</h2>
              ...
              <p className="text-2xl font-bold text-[#8B2D1B] leading-tight text-center md:text-right w-full">
